...
void main() {
  ...
  group('ExerciseItem Widget Tests', () {
    testWidgets('displays exercise category, description, and sets',
      ...
      expect(find.text('A strength training exercise for chest muscles.'),
          findsOneWidget);
    ...
    testWidgets('hides note when it is null', (WidgetTester tester) async {
      ...
      expect(find.text('A compound exercise targeting the lower body.'),
          findsOneWidget);
    ...
    testWidgets('renders correctly with an empty set list',
        (WidgetTester tester) async {
      ...
      expect(
          find.text('A compound exercise for back strength.'), findsOneWidget);
