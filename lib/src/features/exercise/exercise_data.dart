...
const List<ExerciseSet> sampleExerciseSets = [
  ExerciseSet(repititions: 10, weight: 50.0, exerciseSetType: ExerciseSetType.warmup),
  ExerciseSet(repititions: 8, weight: 75.0, exerciseSetType: ExerciseSetType.dropset),
  ExerciseSet(repititions: 6, weight: 100.0, exerciseSetType: ExerciseSetType.tofailure),
];
...
const List<Exercise> sampleExercises = [
  Exercise(
    ...
    sets: [
      ...
      ExerciseSet(repititions: 6, weight: 60.0, exerciseSetType: ExerciseSetType.tofailure),
    ],
  ...
  Exercise(
    ...
    sets: [
      ...
      ExerciseSet(repititions: 5, weight: 90.0, exerciseSetType: ExerciseSetType.dropset),
    ],
  ...
  Exercise(
    ...
    sets: [
      ...
      ExerciseSet(repititions: 10, weight: 50.0),
      ExerciseSet(repititions: 8, weight: 60.0, exerciseSetType: ExerciseSetType.warmup),
    ],
